...
ADRs follow MADR 4.0 plus `Confirmation` ([style guide](../_meta/style-guide.md)). The CI docs gate ([verify-docs.mjs](../../scripts/verify-docs.mjs)) runs markdownlint-cli2, the mermaid-lint step and outline, citation and tag checks per pull request; lychee checks external URLs on a schedule.
