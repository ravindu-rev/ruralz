...
| 12. Nightly | `nightly` | Fuzz, chaos, scale and latency jobs; lychee v0.24.x; supply chain rescan | `make nightly` | Schedule | No; opens an issue and blocks the next release | Planned (M1), including the M1 chaos experiments; control-plane chaos and scale jobs Planned (M2) |
