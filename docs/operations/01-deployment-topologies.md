...
| State Store calls per Cell | 800,000 per second (hypothesis), binding at about 160 Nodes of 5,000 calls per second (hypothesis) | [Bottlenecks](../architecture/11-scalability-and-distributed-state.md#cell-and-cluster-bottlenecks) |
